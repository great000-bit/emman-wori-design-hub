...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-portfolioTheme-secondary">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.4s" }}>
            <form onSubmit={handleSubmit} className="bg-portfolioTheme-cardBg p-6 rounded-lg shadow-lg">
              <div className="mb-4">
